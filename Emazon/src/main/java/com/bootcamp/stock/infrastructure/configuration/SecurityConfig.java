    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/articulo/agregar-cantidad-articulo").hasAnyRole(ROL_AUX_BODEGA, ROL_CLIENTE)
                        .requestMatchers("/articulo/restar-cantidad-articulo").hasRole(ROL_CLIENTE)
                        .requestMatchers("/articulo/get-articulos").permitAll()
                        .requestMatchers("/articulo/articulo-info/*").permitAll()
                        .requestMatchers("/articulo/get-articulos-by-ids").hasRole(ROL_CLIENTE)
